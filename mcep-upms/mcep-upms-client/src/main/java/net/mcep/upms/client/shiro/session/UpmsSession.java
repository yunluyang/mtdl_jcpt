...
public class UpmsSession extends SimpleSession {
    ...
    public String getUpmsSessionId() {
        return upmsSessionId;
    }

    public void setUpmsSessionId(String upmsSessionId) {
        this.upmsSessionId = upmsSessionId;
    }
}
