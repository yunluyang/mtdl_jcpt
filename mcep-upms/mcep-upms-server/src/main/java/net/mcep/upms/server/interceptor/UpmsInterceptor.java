package net.mcep.upms.server.interceptor;
...
public class UpmsInterceptor extends HandlerInterceptorAdapter {
    ...
    private static final String MCEP_OSS_ALIYUN_OSS_POLICY = PropertiesFileUtil.getInstance("mcep-oss-client").get("mcep.oss.aliyun.oss.policy");
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        request.setAttribute("ZHENG_OSS_ALIYUN_OSS_POLICY", MCEP_OSS_ALIYUN_OSS_POLICY);
        // 过滤ajax
