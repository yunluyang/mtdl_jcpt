...
$(function() {
	...
	$table.bootstrapTable({
		...
		columns: [
            ...
            {field: 'organizationCoding', title: '组织机构编码', align: 'center'},
			{field: 'name', title: '组织名称', align: 'center'},
            {field: 'abbreviation', title: '简称', align: 'center'},
            {field: 'description', title: '组织描述', align: 'center'},
//            {field: 'pid', title: '上级组织机构', align: 'center'},
            {field: 'pname', title: '上级组织机构', align: 'center'},
            {field: 'property', title: '属性（是否虚拟组织）', formatter: 'propertyFormatter', align: 'center'},
			{field: 'enact', title: '定编', align: 'center'},
            {field: 'manageLead', title: '分管领导', align: 'center'},
            {field: 'interior', title: '是否内部组织', formatter: 'interiorFormatter', align: 'center'},
...
// 格式化 是否内部组织
function interiorFormatter(value, row, index) {
    if (value == 1) {
        return '<span >是</span>';
    } else {
        return '<span >不是</span>';
