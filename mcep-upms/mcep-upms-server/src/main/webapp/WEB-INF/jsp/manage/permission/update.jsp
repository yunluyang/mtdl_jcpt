	...
	<form id="updateForm" method="post">
		<div class="radio">
			...
			<div class="radio radio-inline radio-warning">
				<input id="type_4" type="radio" name="type" value="4" <c:if test="${permission.type==4}">checked</c:if>>
				<label for="type_4">按钮 </label>
			</div>
		</div>
		<div class="form-group">
			<span class="type1 type2 type3 type4">
			...
			<span class="type2 type3 type4" hidden>
		...
		<div class="form-group type3 type4" hidden>
		...
		<div class="form-group type1 type4">
...
function initType() {
	// 显示对应必填项
	$('.type1,.type2,.type3,.type4').hide(0, function () {
		$('.type' + type).show();
	});
    // 级联菜单
    if (type == 2) {
